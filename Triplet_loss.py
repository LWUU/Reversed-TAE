...
def triplet_semihard_loss(alpha_value, margin, num_classes):
    def loss(y_true, y_pred):
        ...
        labels = tf.convert_to_tensor(y_pred[:, 0], name="labels")
        embeddings = tf.convert_to_tensor(y_pred[:, 1:], name="embeddings")
        ...
        # In lifted-struct, the authors multiply 0.5 for upper triangular in semihard, they take all positive pairs except the diagonal.
